...
defineEmits<{
  (e: 'toggle-demographic', id: string): void
  (e: 'toggle-economic', id: string): void
  ...
  (e: 'update-direction', id: string, direction: string): void
  (e: 'update-filter', id: string, filter: ScoringFilter | null): void
}>()
</script>
